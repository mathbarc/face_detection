...
class FaceDetectionNetV2(nn.Module):
    def __init__(self):
        ...
        self.conv1 = torchvision.ops.Conv2dNormActivation(
            1, 8, activation_layer=torch.nn.ReLU
        )
        self.conv2 = torchvision.ops.Conv2dNormActivation(
            8, 16, activation_layer=torch.nn.ReLU
        )
        self.conv3 = torchvision.ops.Conv2dNormActivation(
            16, 32, activation_layer=torch.nn.ReLU
        )
        self.conv4 = torchvision.ops.Conv2dNormActivation(
            32, 64, activation_layer=torch.nn.ReLU
        )
...
class FaceDetectionNetV3(nn.Module):
    def __init__(self):
        ...
        self.conv5 = torchvision.ops.Conv2dNormActivation(
            64, 128, activation_layer=torch.nn.ReLU
        )
...
class FaceDetectionNetV4(nn.Module):
    def __init__(self):
        super(FaceDetectionNetV4, self).__init__()
        ...
        self.conv1 = torchvision.ops.Conv2dNormActivation(
            1, 32, activation_layer=torch.nn.ReLU
        )
        self.conv2 = torchvision.ops.Conv2dNormActivation(
            32, 64, activation_layer=torch.nn.ReLU
        )
        ...
        self.conv4 = torchvision.ops.Conv2dNormActivation(
            128, 256, activation_layer=torch.nn.ReLU
        )
        self.conv5 = torchvision.ops.Conv2dNormActivation(
            256, 512, activation_layer=torch.nn.ReLU
        )
        self.conv6 = torch.nn.Conv2d(512, 1028, 1)
        self.pool = torch.nn.MaxPool2d(2, 2)
        self.global_pool = torch.nn.AdaptiveMaxPool2d(1)
        self.output = torch.nn.Linear(1028, 136)
        self.flatten = torch.nn.Flatten(1, 3)
